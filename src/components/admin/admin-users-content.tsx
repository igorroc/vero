...
import { grantPlanToUser, type AdminUser } from "@/features/admin"
										...
										<td className="px-5 py-4">
											<Button
												...
												onPress={() => {
													...
													setEndsAt("")
													setGrantingUserId(
														grantingUserId === user.id ? null : user.id,
													)
												}}
											>
												Conceder Plus
											...
											<td colSpan={7} className="px-5 py-4">
														...
														startTransition(() => {
															void grantPlanToUser({
																...
																if (!result.success) {
																	setError(
																		result.error ??
																			"Não foi possível conceder o plano.",
																	)
																	return
																}
												...
												>
													<p className="w-full text-sm text-text-muted">
														Conceda Vero Plus sem criar ou alterar uma
														assinatura paga.
													</p>
													<Input
														label="Válido até"
