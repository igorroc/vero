				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center max-w-4xl mx-auto">
						...
						<p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto">
							...
							quanto você pode gastar por dia e como crescer seu patrimônio de
							forma intencional.
						</p>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<p className="text-lg text-slate-600 dark:text-slate-400">
							A maioria das pessoas controla gastos olhando para o passado. O
							Vero inverte essa lógica: te mostra o futuro para você decidir
							melhor no presente.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Planeje investimentos recorrentes e acompanhe sua jornada rumo
			...
			<section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-7xl mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<p className="text-lg text-slate-600 dark:text-slate-400">
							Ferramentas poderosas e simples de usar para você tomar as
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						{/* Feature 1 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 transition-all hover:shadow-lg">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Visão completa da sua saúde financeira em tempo real. Saldo
								total, limite diário, projeções e alertas importantes.
							</p>
						</div>

						{/* Feature 2 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-purple-500 dark:hover:border-purple-500 transition-all hover:shadow-lg">
						...
						{/* Feature 3 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-green-500 dark:hover:border-green-500 transition-all hover:shadow-lg">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Descubra quanto pode gastar por dia com segurança, considerando
								despesas futuras e sua reserva de emergência.
							</p>
						</div>

						{/* Feature 4 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-amber-500 dark:hover:border-amber-500 transition-all hover:shadow-lg">
						...
						{/* Feature 5 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all hover:shadow-lg">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Automatize seus aportes mensais e acompanhe o progresso rumo às
								suas metas de patrimônio.
							</p>
						</div>

						{/* Feature 6 */}
						<div className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-rose-500 dark:hover:border-rose-500 transition-all hover:shadow-lg">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Defina um valor mínimo que você quer manter em conta. O sistema
								nunca vai sugerir gastar sua reserva.
							</p>
						</div>
					</div>
				</div>
			...
			>
				<div className="max-w-7xl mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<p className="text-lg text-slate-600 dark:text-slate-400">
							Em poucos minutos você já terá uma visão clara do seu futuro
							financeiro.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-4 gap-8">
						<div className="relative">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Adicione suas contas bancárias, dinheiro em espécie e contas de
								investimento com o saldo atual.
							</p>
							<div className="hidden md:block absolute top-6 left-full w-full h-0.5 bg-gradient-to-r from-blue-500 to-transparent" />
						</div>
						...
						<div className="relative">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Cadastre suas receitas e despesas conhecidas: salário, aluguel,
								contas fixas, etc.
							</p>
							<div className="hidden md:block absolute top-6 left-full w-full h-0.5 bg-gradient-to-r from-blue-500 to-transparent" />
						</div>
						...
						<div className="relative">
							...
							<p className="text-slate-600 dark:text-slate-400">
								O dashboard mostra sua projeção financeira, limite diário e
								alertas importantes.
							</p>
							<div className="hidden md:block absolute top-6 left-full w-full h-0.5 bg-gradient-to-r from-blue-500 to-transparent" />
						</div>
						...
						<div>
							...
							<p className="text-slate-600 dark:text-slate-400">
								Quando um evento realmente acontecer, confirme para atualizar
								seu saldo real.
							</p>
						</div>
					</div>
							...
							<div className="space-y-6">
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-slate-600 dark:text-slate-400">
											Saber quanto pode gastar por dia elimina a ansiedade
											financeira.
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-slate-600 dark:text-slate-400">
											Identifique problemas com semanas de antecedência e tenha
											tempo para agir.
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-slate-600 dark:text-slate-400">
											Planeje investimentos recorrentes e veja seu patrimônio
											crescer.
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-slate-600 dark:text-slate-400">
											Sem categorização manual de cada gasto. Foco no que
											importa: o futuro.
										</p>
									</div>
								</div>
							...
							<div className="space-y-4">
								<div className="bg-white/10 rounded-xl p-4">
									<p className="text-lg font-medium">
										&quot;Quanto posso gastar hoje sem comprometer meu
										futuro?&quot;
									</p>
								</div>
								<div className="bg-white/10 rounded-xl p-4">
									<p className="text-lg font-medium">
										&quot;O que vai acontecer com meu dinheiro nos próximos 90
										dias?&quot;
									</p>
								</div>
								<div className="bg-white/10 rounded-xl p-4">
									<p className="text-lg font-medium">
										&quot;Estou no caminho certo para crescer meu
										patrimônio?&quot;
									</p>
								</div>
							</div>
			...
			<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-purple-700">
				<div className="max-w-4xl mx-auto text-center">
					...
					<p className="text-xl text-blue-100 mb-10">
						Comece agora mesmo. É gratuito e leva menos de 5 minutos para
						configurar.
					</p>
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						<Button
				...
				<div className="max-w-7xl mx-auto">
					<div className="flex flex-col md:flex-row items-center justify-between gap-6">
						...
						<p className="text-slate-400 text-center">
							Vero - Seu copiloto financeiro pessoal. Planeje seu futuro com
							confiança.
						</p>
					...
					<div className="mt-8 pt-8 border-t border-slate-800 text-center text-slate-500 text-sm">
						&copy; {new Date().getFullYear()} Vero. Todos os direitos
						reservados.
					</div>
				</div>
			</footer>
